 ...
 static JPanel a1;
   ...
   static JFrame f=new JFrame();
    ...
    Client(){
        ...
        p1.setBackground(new Color(4,2,115));
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/3.png"));
        ...
        JLabel name=new JLabel("Ram Charan");
        ...
        send.setBackground(new Color(4,2,115));
    ...
    public static JPanel formatLabel(String out){
        ...
        JLabel output=new JLabel("<html><p style=\"width:150px\">" + out + "</p></head>");
        
        output.setFont(new Font("Tahoma",Font.PLAIN,16));
        output.setBackground(new Color(117,114,252));
